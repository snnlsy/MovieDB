...
extension MoviesViewModel {
    ...
    private func fetchTopRatedMovies() {
        ...
        var urlQueryItem = [URLQueryItem(name: K.Api.KeyWord.apiKey, value: K.Api.key)]
        urlQueryItem.append(URLQueryItem(name: K.Api.KeyWord.page, value: String(describing: topRatedMoviesPage)))
    ...
    private func fetchMostPopularMovies() {
        ...
        var urlQueryItem = [URLQueryItem(name: K.Api.KeyWord.apiKey, value: K.Api.key)]
        urlQueryItem.append(URLQueryItem(name: K.Api.KeyWord.page, value: String(describing: mostPopularMoviesPage)))
        urlComponents.queryItems = urlQueryItem
        guard let url = urlComponents.url else { return }
